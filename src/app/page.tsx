        ...
        <svg className="w-[200px]" width="383" height="820" viewBox="0 0 383 820" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g id="phone" filter="url(#filter0_d_1533_500)">
            <g clip-path="url(#clip0_1533_500)">
              ...
              <g id="Contents">
                <g className="skeleton" clip-path="url(#clip1_1533_500)">
                  <g id="Frame" clip-path="url(#clip2_1533_500)">
                    <g id="Frame_2">
                  ...
                  <g id="Frame_3" clip-path="url(#clip3_1533_500)">
                    <g id="Frame_4">
                  ...
                  <g id="Frame_5" clip-path="url(#clip4_1533_500)">
                    <g id="Frame_6">
                  ...
                  <g id="Frame_7" clip-path="url(#clip5_1533_500)">
                    <g id="Frame_8">
                  ...
                  <g id="Frame_9" clip-path="url(#clip6_1533_500)">
                    <g id="Frame_10">
                  ...
                  <g id="Frame_11" clip-path="url(#clip7_1533_500)">
                    <g id="Frame_12">
                ...
                <g className="skeleton" clip-path="url(#clip8_1533_500)">
            ...
            <rect x="5" y="1" width="373" height="810" rx="49" stroke="#D1D5DB" stroke-width="2" />
          </g>
          <defs>
            <filter id="filter0_d_1533_500" x="0" y="0" width="383" height="820" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
