...
export default function PhoneSVG() {
    useLayoutEffect(() => {
        ...
        const phoneTL = gsap.timeline({
            scrollTrigger: { trigger: "#phone", toggleActions: 'play none none reset' }
        })

        phoneTL.set(elements, { opacity: 0 });
